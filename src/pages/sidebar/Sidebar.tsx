...
const Container = ({ children }: PropsWithChildren) => <div>{children}</div>// styled.div<{ $isVisible: boolean }>`
    ...
    // }
// `
const HamburgerContainer = ({ children }: PropsWithChildren) => <div>{children}</div>// styled.div<{ $isVisible: boolean }>`
//     background: white;
...
//     }
// `
const ItemContainer = ({ children }: PropsWithChildren) => <div>{children}</div>// styled.div`
//     flex-grow: 1;
